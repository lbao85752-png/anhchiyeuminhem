...
local vu32 = loadstring(game:HttpGet("https://raw.githubusercontent.com/lbao85752-png/anhchiyeuminhemthoi/refs/heads/main/Anhmaydeptrainhatxom.lua"))();
local v466 = vu32:MakeWindow({
    Title = "Sukuna Hub",
    SubTitle = "By Real_1phan2",
    SaveFolder = "SukunaOntop | redz lib v5.lua"
})

v466:AddMinimizeButton({
    Button = { Image = "rbxassetid://105702550629221", BackgroundTransparency = 1},
